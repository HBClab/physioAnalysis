...
# Timestamp: 2020-04-18 16:27:54 UTC
# 
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "curl -o /tmp/code-server.tar.gz -SL https://github.com/cdr/code-server/releases/download/3.0.2/code-server-3.0.2-linux-x86_64.tar.gz" \
    \n    ], \
    \n    [ \
    \n      "run", \
    ...
    \n    [ \
    \n      "entrypoint", \
    \n      "/opt/codeserver/code-server --auth none --host 0.0.0.0 /home/neuro/physioAnalysis" \
    \n    ] \
    \n  ] \
